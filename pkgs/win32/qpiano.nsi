...
;General
    ...
    ; The file to write
    OutFile "QPianoInstall.exe"

    ; The default installation directory
    InstallDir "$PROGRAMFILES\QPiano"

    ; Registry key to check for directory (so if you install again, it will
    ; overwrite the old one automatically)
    InstallDirRegKey HKCU "Software\NSIS_QPiano" ""
...
;Pages
    ...
    !define MUI_STARTMENUPAGE_REGISTRY_KEY "Software\NSIS_QPiano"
...
Section "Install Section"
    ...
    ; Put file there
    File FilesForRelease\qpiano.exe
    ...
    WriteRegStr HKCU SOFTWARE\NSIS_QPiano "" "$INSTDIR"
    ...
    !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
        ...
        CreateShortCut "$SMPROGRAMS\$StartMenuFolder\QPiano.lnk" "$INSTDIR\qpiano.exe" "" "$INSTDIR\qpiano.exe" 0
...
Section "Uninstall"
    ...
    DeleteRegKey /ifempty HKCU "Software\NSIS_QPiano"
